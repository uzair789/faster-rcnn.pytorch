...
CDC=0.01
RDC=1
EXP_NAME="adam_Lr0.0001_fasterRCNN_resnet18_binarynet_distillation_head_KLloss_LambdaLR_CDC${CDC}_RDC${RDC}"
...
#NET='res18'
NET='birealnet18'
python trainval_net.py --o 'adam' --cdc ${CDC} --rdc ${RDC} --scheduler 'LambdaLR' --caption ${CAPTION} --server ${SERVER} --cuda --mGPUs --exp_name $EXP_NAME --lr $LR --dataset='coco' --epochs 12 --net ${NET} #--basenet=$PRETRAIN_MODEL  #--nw 1 --bs 1

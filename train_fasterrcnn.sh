...
#NET='res18'
NET='birealnet18'
python trainval_net.py --o 'adam' --cdc 0 --rdc 0 --scheduler 'LambdaLR' --caption ${CAPTION} --server ${SERVER} --cuda --mGPUs --exp_name $EXP_NAME --lr $LR --dataset='coco' --epochs 12 --net ${NET} #--basenet=$PRETRAIN_MODEL  #--nw 1 --bs 1

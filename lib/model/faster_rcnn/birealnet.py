...
from model.binary_units import BinaryActivation, HardBinaryConv
...
def birealnet18(pretrained=False, **kwargs):
    print("""Constructs a BiRealNet-18 model. """)
...
class birealnet(_fasterRCNN):
  def __init__(self, classes, num_layers=18, pretrained=False, class_agnostic=False):
    self.model_path = '/media/apple/pytorch-retinanet/BiRealNet18_Imagenet_pretrain/imagenet_baseline/checkpoint.pth.tar'
  ...
  def _init_modules(self):
    ...
    self.RCNN_base = nn.Sequential(resnet.conv1, resnet.bn1,
      resnet.maxpool,resnet.layer1,resnet.layer2,resnet.layer3)
